...
Контур Human-in-the-Loop реализован средствами рабочего места команды и поддерживает ручной, гибридный и автономный режимы утверждения. Для отдельных материалов назначается согласование с компанией; решение компании фиксируется сотрудником команды. Материал, не получивший утверждения, в публикацию не передаётся.
