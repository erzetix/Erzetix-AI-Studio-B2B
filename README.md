...
Контур Human-in-the-Loop реализован средствами рабочего места команды. Каждый материал перед публикацией утверждается специалистом команды; до утверждения материал проходит автоматические циклы доработки по замечаниям агента-хранителя бренда. Утверждение и возврат на доработку выполняются для каждого материала отдельно. Для отдельных материалов назначается согласование с компанией; решение компании фиксируется специалистом команды. Материал, не получивший утверждения, в публикацию не передаётся.
