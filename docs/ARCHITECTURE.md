...
Для отдельных материалов назначается согласование с компанией. Решение компании, полученное вне комплекса, фиксируется сотрудником команды; до его фиксации материал в публикацию не передаётся.
...
К защищаемым сведениям относятся параметры идентичности персонажей (Character DNA, Facial DNA, Body DNA, Style DNA, Prompt DNA), системные промпты подсистем, шаблоны технических промптов, правила допустимого контента, требования брендов клиентов, учётные данные доступа к внешним сервисам и к аккаунтам компаний.
